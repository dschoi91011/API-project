...
function ReviewFormModal(){
    ...
    return(
        ...
        <label htmlFor="user-review"><textarea id='user-review' rows='2' cols='100' placeholder='Leave your review here...' value={review} onChange={e => setReview(e.target.value)}/></label>
        <label htmlFor="star-rating"><input type="radio" id="star5" value='5'/>5 Stars</label>
        <label htmlFor="star-rating"><input type="radio" id="star4" value='4'/>4 Stars</label>
